...
if(Ext.form.TextField){
   Ext.apply(Ext.form.TextField.prototype, {
      minLengthText: "O tamanho m&iacute;nimo para este campo &eacute; {0} caracteres",
      maxLengthText: "O tamanho m&aacute;ximo para este campo &eacute; {0} caracteres",
