function Matriz_Pedido_Compra() {
        ...
        items: [{
            ...
            handler: function () {
                ...
                _ajax.setUrl(TB_MATRIZ_PEDIDO_TP.activeTab.title == 'Formato da Primeira P&aacute;gina' ?
                        'servicos/TB_PEDIDO_COMPRA.asmx/Salva_Matriz_Primeira_Pagina' :
                        'servicos/TB_PEDIDO_COMPRA.asmx/Salva_Matriz_Proximas_Paginas');
    ...
    function Busca_Primeira_Pagina() {
        var _ajax = new Th2_Ajax();
        _ajax.setUrl('servicos/TB_PEDIDO_COMPRA.asmx/Matriz_Primeira_Pagina');
    ...
    function Busca_Proximas_Paginas() {
        var _ajax = new Th2_Ajax();
        _ajax.setUrl('servicos/TB_PEDIDO_COMPRA.asmx/Matriz_Proximas_Paginas');
        _ajax.setJsonData({ ID_USUARIO: _ID_USUARIO });
